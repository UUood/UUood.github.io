...
document.getElementById("Sadsvg").addEventListener("click", function sadJS() {
...
document.getElementById("Joyfulsvg").addEventListener("click", function joyfulJS() {
...
document.getElementById("Sillysvg").addEventListener("click", function sillyJS() {
...
document.getElementById("Angrysvg").addEventListener("click", function angryJS() {
